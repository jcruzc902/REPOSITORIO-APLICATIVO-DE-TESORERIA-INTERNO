...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><b>Eliminar Datos de Saldo Bancario</b></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="bi bi-pencil"></i> Eliminar Datos de Saldo Bancario</a>
                        </li>
                    </ol>
                </div>
            </div><!-- /.row -->
                ...
                <div class="col-md-12">
                    <div class="card card-dark">
                        <div class="card-header">
                            <h3 class="card-title">¿Esta seguro de eliminar el saldo bancario seleccionado?
                            </h3>
                        ...
                        <div class="card-body" style="display: inline;">
                            ...
                            <form action="../app/controllers/saldos/ocultar_saldos.php" method="post">
                                ...
                                ?>
                                    ...
                                    <div class="form-group col-md-4" id="">
                                        ...
                                        <input type="text" class="form-control " name="observacion" value="<?php echo $observacion; ?>" required>
                                    </div>
