...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><b>Actualizar Datos de Saldo Bancario</b></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="bi bi-pencil"></i> Actualizar Datos de Saldo Bancario</a>
                        </li>
                    </ol>
                </div>
            </div><!-- /.row -->
                ...
                <div class="col-md-12">
                    <div class="card card-dark">
                        <div class="card-header">
                            <h3 class="card-title">Digite los datos de saldo bancario a actualizar</h3>
                        ...
                        <div class="card-body" style="display: inline;">
                            ...
                            <form action="../app/controllers/saldos/update.php" method="post">
                                ...
                                ?>
                                    ...
                                    <div class="form-group col-md-2" id="">
                                        ...
                                        <input type="text" class="form-control " name="monto" value="<?php echo $monto_saldo; ?>">
                                    </div>
