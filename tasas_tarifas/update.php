                ...
                <div class="col-md-12">
                    <div class="card card-dark">
                        ...
                        <div class="card-body" style="display: inline;">
                            ...
                            <form action="../app/controllers/tasas_tarifas/update.php" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2" id="">
                                        ...
                                        <input type="text" class="form-control " name="codigo_pago"
                                            ...
                                            placeholder="Codigo de Pago" value="<?php echo $codigo_pago; ?>" required>
                                    </div>
                                    ...
                                    <div class="form-group col-md-2" id="">
                                        ...
                                        <input type="text" class="form-control " name="clasificador" id="clasificador"
                                            placeholder="Clasificador" value="<?php echo $clasificador; ?>" >
                                    </div>

                                    <div class="form-group col-md-2" id="">
                                        <label for="">Codigo de Facultad</label>
                                        <input type="text" class="form-control " name="codigo_facultad"
                                            id="codigo_facultad" placeholder="Codigo de Facultad" value="<?php echo $codigo_facultad; ?>" >
                                    </div>
                                    ...
                                    <div class="form-group col-md-2" id="">
                                        ...
                                        <input type="text" class="form-control " name="codigo_serv_banco"
                                            ...
                                            onkeypress='return validaNumericos(event)' value="<?php echo $codigo_ser_banco; ?>" >
                                    </div>
                                    ...
                                    <div class="form-group col-md-2" id="">
                                        ...
                                        <select class="form-control " name="cuenta" id="combo_cuenta" style="width:100%"
                                            ...
                                            foreach ($cuenta_tyt_datos as $cuenta_tyt_dato) {
                                                ...
                                                <option value="<?php echo $nombre_cuenta_tyt_tabla; ?>" <?php if ($nombre_cuenta_tyt_tabla == $cta) { ?> selected="selected"
                                                    <?php } ?>>
