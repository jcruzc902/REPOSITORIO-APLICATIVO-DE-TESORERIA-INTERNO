                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2" id="">
                                        ...
                                        <input type="text" class="form-control " name="codigo_pago"
                                            ...
                                            placeholder="Codigo de Pago" value="<?php echo $codigo_pago; ?>" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-2" id="">
                                        ...
                                        <input type="text" class="form-control " name="codigo_facultad"
                                            id="codigo_facultad" maxlength="10" placeholder="Codigo de Facultad" value="<?php echo $codigo_facultad; ?>" >
                                    </div>
