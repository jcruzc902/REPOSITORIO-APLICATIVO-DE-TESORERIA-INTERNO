                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2" id="" hidden>
                                        ...
                                        <input type="text" class="form-control " name="codigo_serv_banco"
                                            ...
                                            onkeypress='return validaNumericos(event)' value="<?php echo $codigo_ser_banco; ?>" maxlength="3">
                                    </div>
                                    ...
                                    <div class="form-group col-md-2" id="">
                                        ...
                                        <input type="text" class="form-control " name="codigo_serv_banco"
                                            id="codigo_serv_banco" placeholder="Codigo de Servicio Banco"
                                            onkeypress='return validaNumericos(event)' value="<?php echo $codigo_ser_banco; ?>" maxlength="3" disabled>
                                    </div>
