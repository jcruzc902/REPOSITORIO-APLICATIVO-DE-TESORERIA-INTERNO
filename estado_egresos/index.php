...
if (isset($_POST["consultar"])) {
    ...
    */
    ...
    if ($cargo!="" && $actividad_principal!="" && $subactividad!="") {
        $sql_egresos .= " AND egresos.subactividad='" . $subactividad . "'";
    }
                            ...
                            <form action="index" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <?php
                                        ...
                                        WHERE subactividad.visible!=1 AND actividad_principal.nombre_actividad='$_POST[actividad_principalX]' ORDER BY subactividad.nombre_subactividad ASC";
