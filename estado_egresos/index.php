                            ...
                            <form action="index" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <?php
                                        ...
                                        where cargo.nombre_cargo='$_POST[cargoX]' ORDER BY actividad_principal.nombre_actividad ASC";
                                        ...
                                        WHERE actividad_principal.nombre_actividad='$_POST[actividad_principalX]' ORDER BY subactividad.nombre_subactividad ASC";
                                    ...
                                    <div class="form-group col-md-4" id="campo_anio_nt">
                                        ...
                                        <select class="form-control " name="subactividadX" id="combo_subactividad"
                                            ...
                                            foreach ($subactividad_datos as $subactividad_dato) {
                                                ...
                                                <option value="<?php echo $nombre_subactividad_tabla; ?>" <?php if ($nombre_subactividad_tabla == $_POST["subactividadX"]) { ?> selected="selected"
                                                    <?php } ?>>
                        ...
                        if (!isset($egresos_datos)) {
                            ...
                            foreach ($egresos_datos as $egresos_dato) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $egresos_dato['subactividad']; ?>
                                    </td>
