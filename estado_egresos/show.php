...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><b>Datos del Estado de Cuenta</b></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="bi bi-search"></i> Informacion del estado de egreso</a></li>
                    </ol>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card card-dark">
                        <div class="card-header">
                            <h3 class="card-title">Informacion del estado de egreso seleccionado</h3>
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <form action="#">
                                ...
                                <?php
                                        ...
                                        WHERE actividad_principal.nombre_actividad='$actividad_principal' ORDER BY subactividad.nombre_subactividad ASC";
                                    ...
                                    <div class="form-group col-md-4" id="campo_anio_nt">
                                        ...
                                        <div style="display: flex;">
                                            <select class="form-control " name="nombre_subactividad"
                                                id="combo_subactividad" style="width:100%" disabled>
                                                <option value="">SELECCIONAR</option>
                                                <?php
                                                ...
                                                ?>
                                                    <option value="<?php echo $subactividad_dato['nombre_subactividad']; ?>" <?php if ($nombre_subactividad_tabla == $subactividad) { ?> selected="selected" <?php } ?>>
                                                        <?php echo $subactividad_dato['nombre_subactividad']; ?>
                                                    </option>
                                                    <?php
                                                }
                                                ?>
                                    ...
                                    <div class="form-group col-md-2" id="campo_fecha_registro">
                                        ...
                                        <input type="text" class="form-control " name="fecha_registro"
                                            value="<?php echo $fyh_creacion_egreso; ?>" disabled>
                                    </div>
