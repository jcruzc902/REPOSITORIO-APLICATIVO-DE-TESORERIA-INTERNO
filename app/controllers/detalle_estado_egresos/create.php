...
if ($contador == 1) {
    ...
    asunto,informe,fecha_informe,resolucion,fecha_resolucion,egresos,ingresos,saldo,facultad,actividad_principal,subactividad,periodo,id_usuario,visible,fyh_creacion) 
    ...
    :egresos,:ingresos,:saldo,:facultad,:actividad_principal,:subactividad,:periodo,:id_usuario,:visible,:fyh_creacion)");
