...
class PDF extends FPDF
{
    public function header()
    {
        ...
        $this->SetY(65);
        $this->SetFont('Arial', 'B', 8); //fuente
        $this->Cell(225); //mover a la derecha
...
if (!isset($saldo_bancario_datos)) {
    ...
    foreach ($saldo_bancario_datos as $saldo_bancario_dato) {
        ...
        $pdf->Cell(25, 5, utf8_decode($saldo_bancario_dato["nombre_banco"]));
        ...
        $pdf->Cell(35, 5, utf8_decode($saldo_bancario_dato["numero_cuenta"]));

        $saldo_bancario_dato["nombre_cuenta"] = substr($saldo_bancario_dato["nombre_cuenta"], 0, 45); //cortar cadena

        $pdf->Cell(85, 5, utf8_decode($saldo_bancario_dato["nombre_cuenta"]));
        ...
        $pdf->Cell(35, 5, utf8_decode($saldo_bancario_dato["cuenta_saldo"]));
        $pdf->Cell(35, 5, utf8_decode($saldo_bancario_dato["nombre_situacion"]));
        ...
        $pdf->Cell(30, 5, utf8_decode($saldo_bancario_dato["monto_saldo"]));
        ...
        $pdf->Cell(24, 5, utf8_decode($fecha_saldo));
