...
if (!isset($tasas_tarifas_datos)) {
    ...
    foreach ($tasas_tarifas_datos as $tasas_tarifas_dato) {
        ...
        */
        ...
        $pdf->Cell(24, 5, utf8_decode($tasas_tarifas_dato["monto"]));
        $pdf->Cell(30, 5, utf8_decode($tasas_tarifas_dato["dependencia"]));

        $pdf->Cell(25, 5, utf8_decode($tasas_tarifas_dato["banco"]));
        $pdf->Cell(35, 5, utf8_decode($tasas_tarifas_dato["cta"]));
