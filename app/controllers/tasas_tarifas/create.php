...
codigo_facultad,dependencia,codigo_ser_banco,banco,cta,resolucion,archivo_resolucion,vigencia,situacion,categoria_transaccion,id_estado,visible,id_usuario,fyh_creacion) 
    VALUES (:codigo_pago,:modalidad,:concepto,:monto,:referencia,:clasificador,:codigo_facultad,:dependencia,
    :codigo_ser_banco,:banco,:cta,:resolucion,:archivo_resolucion,:vigencia,:situacion,:categoria_transaccion,:id_estado,:visible,:id_usuario,:fyh_creacion)');
