...
codigo_facultad,dependencia,codigo_ser_banco,banco,cta,vigencia,situacion,categoria_transaccion,observacion,id_estado,visible,id_usuario,fyh_creacion) 
    VALUES (:codigo_pago,:modalidad,:concepto,:referencia,:clasificador,:codigo_facultad,:dependencia,
    :codigo_ser_banco,:banco,:cta,:vigencia,:situacion,:categoria_transaccion,:observacion,:id_estado,:visible,:id_usuario,:fyh_creacion)');
