...
if ($contador == 1) {
    ...
    id_dependencia,id_usuario,id_anio_nt,id_anio_periodo,fyh_creacion) 
    VALUES (:nt,:proveido,:fecha_proveido,:oficio,:fecha_oficio,:informe,:fecha_informe,:observacion_devolucion,:id_dependencia,:id_usuario,:id_anio_nt,
