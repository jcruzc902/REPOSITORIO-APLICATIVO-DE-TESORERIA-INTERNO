...
foreach ($_POST['id_nrocuenta'] as $key => $value) {
    ...
    if ($contador != 1) {
        ...
        nro_envio,fecha_aprobado,fecha_entregado,fecha_pagado,id_estado_cheque,observacion,id_usuario,nt,id_anio_nt,id_asunto,fyh_creacion) 
    VALUES (:id_nrocuenta,:nro_ci,:fecha_ci,:nro_ce,:fecha_ce,:nro_cheque,:fecha_emision_cheque,:siaf,:monto,:nro_envio,
        :fecha_aprobado,:fecha_entregado,:fecha_pagado,:id_estado_cheque,:observacion,:id_usuario,:nt,:id_anio_nt,:id_asunto,:fyh_creacion)');
