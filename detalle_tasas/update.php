                ...
                <div class="col-md-12">
                    <div class="card card-dark">
                        ...
                        <div class="card-body" style="display: inline;">
                            ...
                            <form action="../app/controllers/detalle_tasas/update.php" method="post">
                                    ...
                                    <div class="form-group col-md-3" id="" hidden>
                                        ...
                                        <select class="form-control " name="archivo_resolucion" id="combo_archivo"
                                            ...
                                            foreach ($resolucion_datos as $resolucion_dato) {
                                                ...
                                                <option value="<?php echo $nombre_archivo_tabla; ?>" <?php if ($nombre_archivo_tabla == $archivo) { ?> selected="selected"
                                                    <?php } ?>>
