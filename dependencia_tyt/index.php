                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label class="float-left">Nombre de dependencia</label>
                                                                                <input type="text"
                                                    ...
                                                    <script>
                                                        $('#btn_update<?php echo $id_dependencias_tyt; ?>').click(function () {
                                                            ...
                                                            if (nombre_dependencias_tyt == "") {
                                                                ...
                                                                $.get(url, { nombre_dependencias_tyt: nombre_dependencias_tyt, id_dependencias_tyt: id_dependencias_tyt }, function (datos) {
