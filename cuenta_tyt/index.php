                            ...
                            <table id="example1" class="table table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    foreach ($cuenta_tyt_datos as $cuenta_tyt_dato) {
                                        ...
                                        $nombre_cuenta_tyt = $cuenta_tyt_dato['nombre_cuenta_tyt'];
                                        ?>
                                        <tr>
                                            <td>
                                                <center>
                                            ...
                                            <td>
                                                <?php echo mb_strtoupper($cuenta_tyt_dato['nombre_cuenta_tyt']); ?>
                                            </td>
                                            <td>
                                                <center>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label class="float-left">Numero de
                                                                                    cuenta</label>
                                                                                <input type="text"
                                                                                    id="nombre_cuenta_tyt<?php echo $id_cuenta_tyt; ?>"
                                                                                    value="<?php echo $nombre_cuenta_tyt; ?>"
                                                                                    class="form-control ">
                                                    ...
                                                    <script>
                                                        $('#btn_update<?php echo $id_cuenta_tyt; ?>').click(function () {
                                                            var nombre_cuenta_tyt = $('#nombre_cuenta_tyt<?php echo $id_cuenta_tyt; ?>').val();
                                                            var id_cuenta_tyt = '<?php echo $id_cuenta_tyt; ?>';

                                                            if (nombre_cuenta_tyt == "") {
                                                                $('#nombre_cuenta_tyt<?php echo $id_cuenta_tyt; ?>').focus();
                                                                $('#lbl_update<?php echo $id_cuenta_tyt; ?>').css('display', 'block');
                                                            } else {
                                                                var url = "../app/controllers/cuenta_tyt/update.php";
                                                                $.get(url, { nombre_cuenta_tyt: nombre_cuenta_tyt, id_cuenta_tyt: id_cuenta_tyt }, function (datos) {
...
<script>
    $('#btn_create').click(function () {
        ...
        if (numero_cuenta == "") {
            ...
            $.get(url, { numero_cuenta: numero_cuenta }, function (datos) {
