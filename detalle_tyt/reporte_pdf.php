...
$sql_tasas_tarifas = "SELECT detalle_tyt.id_detalle_tyt as id_detalle_tyt,
 ...
 WHERE detalle_tyt.visible!=1 AND tasas_tarifas.visible!=1 AND estado_resolucion.nombre_estado_resolucion='APROBADO' AND tasas_tarifas.situacion IN ('INCORPORACION','ACTUALIZACION','MODIFICACION') ";
...
if (!isset($tasas_tarifas_datos)) {
    ...
    switch($tasas_tarifas_dato["dependencia"]){
        ...
        $tasas_tarifas_dato["resolucion"]= str_replace("RESOLUCION RECTORAL","R.R.",$tasas_tarifas_dato["resolucion"]);
