            ...
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h1 class="m-0"><b>Consulta de Roles</b>
                        <button type="button" class="btn btn-default bg-primary" style="display: inline;" data-toggle="modal"
                ...
                <div class="card-body">
                    ...
                    <div id="accordion">
                        ...
                        <div class="card card-dark">
                            ...
                            <div id="collapseFour" class="collapse" data-parent="#accordion" style="">
                                <div class="card-body">
                                    El rol de diga solo tiene disponible el modulo de tasas y tarifas.
                                </div>
                            </div>
                        </div>
                    </div>
