                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body" style="display: inline;">
                            ...
                            <form action="../app/controllers/detalle_estado_egresos/update.php" method="post">
                                ...
                                <input type="text" name="saldo_inicial" value="<?php echo $saldo_inicial; ?>" hidden>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2" id="">
                                        ...
                                        <input type="text" class="form-control " name="proveido_contabilidad" id="nt"
                                            ...
                                            value="<?php echo $proveido_contabilidad; ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-2" id="">
                                        ...
                                        <input type="date" class="form-control " name="fecha_proveido_contabilidad"
                                            ...
                                            value="<?php echo $fecha_proveido_contabilidad; ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-2" id="">
                                            ...
                                            <input type="text" class="form-control " name="total_egresos" id="total_egresos" value="<?php echo $total_egresos; ?>">
                                    </div>
                                    ...
                                    <div class="form-group col-md-8" id="">
                                        ...
                                        <input type="text" class="form-control " name="asunto" id="asunto"
                                            ...
                                            value="<?php echo $asunto; ?>" required>
                                    </div>
                                    ...
                                    <script>
                                        ...
                                        <div class="form-group col-md-2" id="">
                                            ...
                                            <input type="text" class="form-control " name="especialidad" id="especialidad" placeholder="Especialidad" value="<?php echo $especialidad; ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-md-2" id="">
                                            ...
                                            <input type="text" class="form-control " name="periodo_meses" id="periodo_meses" placeholder="Periodo" value="<?php echo $periodo_meses; ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-md-2" id="">
                                            ...
                                            <input type="text" class="form-control " name="orden_compra"
                                                ...
                                                placeholder="N° Orden Compra" value="<?php echo $nro_orden_compra; ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-md-2" id="">
                                            ...
                                            <input type="text" class="form-control " name="monto" id="monto"
                                                onkeypress='return validaNumericos(event)' placeholder="Monto" value="<?php echo $monto; ?>" required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-2" id="">
                                            ...
                                            <input type="text" class="form-control " name="egreso" id="egreso"
                                                ...
                                                placeholder="Total de Egresos" value="<?php echo $egresos; ?>" required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-2" id="">
                                            ...
                                            <input type="text" class="form-control " name="ingreso" id="ingreso"
                                                ...
                                                value="<?php echo $ingresos; ?>" required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-2" id="">
                                            ...
                                            <input type="text" class="form-control " name="numero_estado_cuenta" id="numero_estado_cuenta"
                                                value="<?php echo $numero_ec; ?>" >
                                        </div>

                                        <div class="form-group col-md-2" id="">
                                            <label for="">Fecha Estado de Cuenta</label>
                                            <input type="date" class="form-control " name="fecha_estado_cuenta"
                                                id="fecha_estado_cuenta" value="<?php echo $fecha_ec; ?>">
                                        </div>

                                        <div class="form-group col-md-2" id="">
                                            <label for="">Informe de Ingreso</label>
                                            <input type="text" class="form-control " name="informe_ingreso" id="informe_ingreso" placeholder="Numero-Año" onkeypress='return validaNumericos(event)' value="<?php echo $informe_ingresos; ?>">
                                        </div>

                                        <div class="form-group col-md-2" id="">
                                            <label for="">Fecha Informe Ingreso</label>
                                            <input type="date" class="form-control " name="fecha_informe_ingreso" value="<?php echo $fecha_informe_ingresos; ?>">
                                        </div>
                                        ...
                                        <div class="form-group col-md-8" id="">
                                            ...
                                            <textarea type="text" class="form-control " name="descripcion_ec"
                                                ...
                                                ><?php echo $descripcion_ec; ?></textarea>
                                        </div>
