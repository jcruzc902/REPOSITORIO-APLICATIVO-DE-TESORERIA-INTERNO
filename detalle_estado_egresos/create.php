                            ...
                            <form action="../app/controllers/detalle_estado_egresos/create.php" method="post"
                                ...
                                <div id="show_item">
                                    <div class="form-row">
                                        ...
                                        <?php
                                        $sql_detalle_egresos = "SELECT MAX(informe) as numero_informe FROM tb_detalle_egresos WHERE visible!=1";
                                        ...
                                        #EGRESOS
                                        $sql_monto_egresos = "SELECT * FROM tb_detalle_egresos WHERE facultad='$facultad' 
                                        AND actividad_principal='$actividad' AND subactividad='$subactividad' 
                                        AND periodo='$periodo' AND visible!=1 ORDER BY fyh_creacion DESC LIMIT 1";
                                        $query_monto_egresos = $pdo->prepare($sql_monto_egresos);
                                        $query_monto_egresos->execute();
                                        $monto_egresos_datos = $query_monto_egresos->fetchAll(PDO::FETCH_ASSOC);

                                        foreach ($monto_egresos_datos as $monto_egresos_dato) {
                                            $egresos_monto = $monto_egresos_dato['egresos'];
                                        }


                                        if ($egresos_monto != null) {
                                        ...
                                        #INGRESOS
                                        $sql_monto_ingresos = "SELECT * FROM tb_detalle_egresos WHERE facultad='$facultad' 
                                        AND actividad_principal='$actividad' AND subactividad='$subactividad' 
                                        AND periodo='$periodo' AND visible!=1 ORDER BY fyh_creacion DESC LIMIT 1";
                                        $query_monto_ingresos = $pdo->prepare($sql_monto_ingresos);
                                        $query_monto_ingresos->execute();
                                        $monto_ingresos_datos = $query_monto_ingresos->fetchAll(PDO::FETCH_ASSOC);

                                        foreach ($monto_ingresos_datos as $monto_ingresos_dato) {
                                            $ingresos_monto = $monto_ingresos_dato['ingresos'];
                                        }


                                        if ($ingresos_monto != null) {
                                        ...
                                        <div class="form-group col-md-12" id="monto_ingresos">
                                        ...
                                        <script>
                                            ...
                                            if (ingresos == 0) {
                                                ...
                                                document.getElementById('monto_ingresos').style.display = 'inline';

                                            } else {

                                                document.getElementById('monto_ingresos').style.display = 'none';
                                            }
