    ...
    <div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2 ">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item " id="seccion_cartas_fianza">
                            <a href="#" class="nav-link">
        ...
        if ($rol_sesion == "ADMINISTRADOR") { ?>
            <script>
                ...
                document.getElementById('seccion_detalle_egresos').style.display = 'inline';
                ...
                document.getElementById('seccion_detalle_tarifas').style.display = 'inline';
                ...
                document.getElementById('seccion_banco_tyt').style.display = 'inline';
                document.getElementById('seccion_cuenta_tyt').style.display = 'inline';
                document.getElementById('seccion_nombre_cuenta_tyt').style.display = 'inline';
                document.getElementById('seccion_resolucion').style.display = 'inline';
                document.getElementById('seccion_saldos').style.display = 'inline';
        ...
        <?php } else if ($rol_sesion == "INGRESOS") { ?>
                <script>
                    ...
                    document.getElementById('seccion_principal').style.display = 'inline';
                    document.getElementById('seccion_devoluciones').style.display = 'inline';
                    document.getElementById('seccion_devolucion').style.display = 'inline';
                    document.getElementById('seccion_ingresos').style.display = 'inline';
                    ...
                    document.getElementById('seccion_detalle_egresos').style.display = 'none';
                    ...
                    document.getElementById('seccion_detalle_tarifas').style.display = 'none';
                    ...
                    document.getElementById('seccion_nombre_cuenta_tyt').style.display = 'none';
                    document.getElementById('seccion_resolucion').style.display = 'none';
                    document.getElementById('seccion_saldos').style.display = 'none';
                    document.getElementById('seccion_cartas_fianza').style.display = 'none';
        ...
        <?php } else if ($rol_sesion == "DIGA") { ?>
                            <script>
                                //ocultar las secciones
                                document.getElementById('seccion_principal').style.display = 'inline';
                                document.getElementById('seccion_devoluciones').style.display = 'none';
                                document.getElementById('seccion_egresos').style.display = 'none';
                                document.getElementById('seccion_detalle_egresos').style.display = 'none';
                                document.getElementById('seccion_cargos').style.display = 'none';
                                document.getElementById('seccion_actividades').style.display = 'none';
                                ...
                                document.getElementById('seccion_referencia').style.display = 'none';
                                document.getElementById('seccion_dependencia_tyt').style.display = 'none';
                                document.getElementById('seccion_banco_tyt').style.display = 'none';
                                document.getElementById('seccion_cuenta_tyt').style.display = 'none';
                                document.getElementById('seccion_nombre_cuenta_tyt').style.display = 'none';
                                document.getElementById('seccion_resolucion').style.display = 'none';
                                document.getElementById('seccion_saldos').style.display = 'inline';
        ...
        <!--USUARIO 13 ES MARIA CELIA ESPINOZA MORALES-->
        <?php if ($rol_sesion == "DIGA" && $id_usuario_sesion == 13) { ?>
            <script>
                //ocultar las secciones
                document.getElementById('seccion_principal').style.display = 'inline';
                document.getElementById('seccion_devoluciones').style.display = 'none';
